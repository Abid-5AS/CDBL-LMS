...
export const SUCCESS_MESSAGES = {
  ...
  returned_for_modification: "Request returned to employee for revision",
  ...
  leave_forwarded: "Request forwarded to HR Head",
  leave_resubmitted: "Leave request resubmitted for approval",
