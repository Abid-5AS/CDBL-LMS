...
export const STATUS_COLORS = {
  PENDING: {
    ...
    badge: "bg-amber-50/80 text-amber-800 border-amber-200 dark:bg-amber-900/40 dark:text-amber-100 dark:border-amber-800",
  },
  FORWARDED: {
    ...
    badge: "bg-blue-50/80 text-blue-700 border-blue-200 dark:bg-blue-900/30 dark:text-blue-300 dark:border-blue-800",
  },
  APPROVED: {
    ...
    badge: "bg-emerald-50/80 text-emerald-700 border-emerald-200 dark:bg-emerald-900/30 dark:text-emerald-300 dark:border-emerald-800",
  },
  RETURNED: {
    ...
    badge: "bg-yellow-50/80 text-yellow-800 border-yellow-300 dark:bg-yellow-900/40 dark:text-yellow-200 dark:border-yellow-800",
  },
  CANCELLED: {
    chip: "bg-gray-100 text-gray-700 border-gray-200 hover:bg-gray-200",
    card: "bg-gray-50 dark:bg-gray-950/20 border-gray-200 dark:border-gray-800 text-gray-700 dark:text-gray-300",
    badge: "bg-slate-100/70 text-slate-600 border-slate-200 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-700",
  },
} as const;
 ...
 */
export function getStatusColors(status: string, variant: "chip" | "card" | "badge" = "chip"): string {
