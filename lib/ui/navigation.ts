...
export const roleNavConfig: Record<UserRole, NavItem[]> = {
  ...
  HR_ADMIN: [
    ...
    { icon: ClipboardList, label: "My Leaves", href: "/leaves" },
    { icon: Wallet, label: "Balance", href: "/balance" },
    { icon: Scale, label: "Balance Mgmt", href: "/admin/balance" },
    { icon: ChartBar, label: "Reports", href: "/reports" },
    { icon: Calendar, label: "Holidays", href: "/holidays" },
    { icon: Banknote, label: "Encashment", href: "/encashment/requests" },
    { icon: DollarSign, label: "Payroll", href: "/admin/payroll" },
    { icon: Database, label: "HRIS", href: "/admin/hris" },
    { icon: Settings, label: "Admin Tools", href: "/admin/tools" },
