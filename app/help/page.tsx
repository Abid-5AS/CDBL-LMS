        ...
        <Card>
          <CardHeader>
            <div className="flex items-center gap-2">
              <BookOpen className="h-5 w-5 text-info dark:text-info/90 dark:text-info dark:text-info/90" />
            ...
            <div className="space-y-2 mb-4">
              {KEYBOARD_SHORTCUTS.map((shortcut, idx) => (
                ...
                >
                  ...
                  <kbd className="px-2 py-1 text-xs font-semibold bg-muted dark:bg-muted/80 dark:bg-muted dark:bg-muted/80 border border-border dark:border-border/50 dark:border-border dark:border-border/50 rounded">
                    {shortcut.key}
                  </kbd>
                </div>
              ))}
