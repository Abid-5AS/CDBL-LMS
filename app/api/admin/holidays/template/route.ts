...
/**
 * GET /api/admin/holidays/template
 * Download CSV template for holiday import
 */
export async function GET(req: NextRequest) {
  ...
  const template = ImportExportService.generateHolidayTemplate();

  return new NextResponse(template, {
    headers: {
      "Content-Type": "text/csv",
      "Content-Disposition": 'attachment; filename="holidays_import_template.csv"',
    },
  });
}
