...
async function EmployeesPageContent() {
  ...
  return (
    <div className="space-y-6">
      <section className="rounded-xl border border-border/50 dark:border-slate-800/50 backdrop-blur-xl bg-white/70 dark:bg-card/70 p-6 shadow-sm">
...
function EmployeeListFallback() {
  return (
    <div className="space-y-4">
      <div className="h-12 bg-accent dark:bg-card rounded animate-pulse" />
