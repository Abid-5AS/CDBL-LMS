        ...
        <div className="group relative">
          <DropdownMenuTrigger asChild>
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="flex items-center gap-2.5 px-2.5 py-1 rounded-xl bg-background/80 dark:bg-muted/60 border border-border hover:border-border dark:border-border/50 hover:bg-background dark:hover:bg-muted hover:shadow-md transition-all duration-300 focus:outline-none focus-ring"
            >
          ...
          <DropdownMenuContent
            align="end"
            sideOffset={8}
            className="w-64 p-2 bg-popover border border-border rounded-2xl shadow-xl data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 origin-top-right"
          >
            {/* User Info Header */}
