...
import { Inbox, CheckCircle2, RefreshCcw } from "lucide-react";

export function PendingTableLoading() {
  return (
    <Card variant="glass" interactive={true} className="rounded-2xl border-muted/60 shadow-sm">
      <CardHeader>
...
export function PendingTableNoResults() {
  return (
    <Card variant="glass" interactive={true} className="py-12">
