...
export function SuperAdminDashboard({ username }: SuperAdminDashboardProps) {
  return (
    <div className="space-y-6">
      {/* Header */}
      <section className="flex flex-col gap-3 rounded-xl border border-border bg-card p-4 sm:p-6 shadow-sm md:flex-row md:items-center md:justify-between" aria-label="Super Admin Dashboard Header">
        <div>
          <h2 className="text-2xl font-semibold text-foreground">Super Admin Dashboard</h2>
      ...
      <section className="space-y-4" aria-label="Recent audit logs">
        <div className="flex items-center justify-between flex-col sm:flex-row gap-2 sm:gap-0">
          <h3 className="text-lg font-semibold text-foreground">Recent Audit Logs</h3>
