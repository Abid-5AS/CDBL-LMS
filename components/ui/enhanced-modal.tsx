...
const variantClasses = {
  ...
  glass: "glass-modal border border-white/20 dark:border-white/10 shadow-2xl",
  blur: "bg-background/80 backdrop-blur-xl border border-border/50 shadow-xl",
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className={cn(
              ...
              variant === "glass" && "bg-black/30 backdrop-blur-md",
              overlayClassName
            )}
            onClick={
