...
function Table({ className, ...props }: React.ComponentProps<"table">) {
  return (
    <div
      ...
      className="relative w-full overflow-hidden rounded-xl border border-outline/60 dark:border-border bg-surface-1 shadow-card"
      role="region"
  ...
  return (
    <tr
      ...
      className={cn(
        ...
        "data-[state=selected]:border-outline dark:data-[state=selected]:border-border",
